    ...
    return(
        <div className={`${styles.container}`}>
             <div className={`${styles.options} flex flex-row gap-x-16 font-semibold justify-center items-center`}>
                ...
                <div onClick={()=>setOption(3)} className={`cursor-pointer w-36 h-full flex justify-center ${option === 3 ? 'bg-sky-700': null}`}><span className={`self-center`}>Update School Year</span></div>
            </div>
